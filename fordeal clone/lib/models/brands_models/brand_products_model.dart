class BrandProductsModel{
  List<BrandProductsDataModel>data=[];
  BrandProductsModel.fromJson(var json){
    json.forEach((element) {
      data.add(BrandProductsDataModel.fromJson(element));
    });
  }

}

class BrandProductsDataModel {
  String? id;
  String? prodId;
  String ?userId;
  String? compId;
  ...
  BrandProductsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    prodId = json['prod_id'];
    userId = json['user_id'];
    compId = json['comp_id'];
