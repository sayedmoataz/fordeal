      ...
      body: ListView.builder(
        itemCount: cubit.allBrands!.data.length,
          itemBuilder: (context,index)=>InkWell(
              onTap: (){
                cubit.search( cubit.allBrands!.data[index].catNameAr.toString());
                Navigator.push(context,MaterialPageRoute(builder: (context)=>SearchData(searchData: cubit.allBrands!.data[index].catNameAr.toString())) );
              },
