...
import 'package:secondtask/screens/home_cards.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit,HomeStates>(
      ...
      builder: (context,state){
        ...
        return cubit.featuredCategoriesModel==null?Center(child: CircularProgressIndicator(),): DefaultTabController(
          length:4 ,
          child: Builder(
              builder: (context) {
                return  Scaffold(
  ...
  Widget build(BuildContext context) {
    ...
    return   BlocConsumer<HomeCubit,HomeStates>(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            SearchInput(shownText: 'عم تبحث ؟ ',myContext: context),
            // cardList(),
            SizedBox(
              height: 50,
              child: TabBar(
                ...
                // },
                  ...
                  tabs:
                   List.generate(cubit.tabsNames.length, (index) => FittedBox(
                     child: Text(
