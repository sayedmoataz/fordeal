              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        cubit.singleProductModel!.prodPrice!,
                        style: TextStyle(
                            color: Colors.red,
                ...
                CustomRow(
                  rowTitle: 'Specifications',
                ),
                CustomRow(
                  rowTitle: 'Service Policy',
                ),
                Padding(
                  padding: const EdgeInsets.all(12),
                  child: Row(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  BottomIcons(iconName: 'Save', icona: Icons.favorite_outline),
                  Container(
                    padding: EdgeInsets.all(12),
                    height: 40,
                    width: 200,
...
class BottomIcons extends StatelessWidget {
  const BottomIcons({Key? key, required this.iconName, required this.icona})
      : super(key: key);
