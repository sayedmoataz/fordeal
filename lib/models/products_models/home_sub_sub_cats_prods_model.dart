class HomeSubSubCatProdsModel {
  List<HomeSubSubCatProdsDataModel> data = [];
  HomeSubSubCatProdsModel.fromJson(var json) {
    json.forEach((element) {
      data.add(HomeSubSubCatProdsDataModel.fromJson(element));
    });
  }
}

class HomeSubSubCatProdsDataModel {
  String? id;
  String? prodId;
  String? userId;
  String? compId;
  ...
  HomeSubSubCatProdsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    khasem = json['khasem'];
