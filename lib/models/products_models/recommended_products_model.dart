class RecomProductsModel{
  List<HomeRecomProdsDataModel>data=[];

  RecomProductsModel.fromJson(var json){
    json.forEach((element) {
      data.add(HomeRecomProdsDataModel.fromJson(element));
    });
  }
}

class HomeRecomProdsDataModel {
  String? id;
  String? prodId;
  String? userId;
  String? compId;
  ...
  HomeRecomProdsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    khasem = json['khasem'];
