class Screen4DetailsProdsModel{
  List<Screen4DetailsProdsDataModel>data=[];

  Screen4DetailsProdsModel.fromJson(var json){
    json.forEach((element) {
      data.add(Screen4DetailsProdsDataModel.fromJson(element));
    });
  }
}
class Screen4DetailsProdsDataModel {
  String? id;
  String? prodId;
  String? userId;
  String? compId;
  ...
  Screen4DetailsProdsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    khasem = json['khasem'];
