class VendorProductsModel{
  List<VendorProductsDataModel>data=[];
  VendorProductsModel.fromJson(var json){
    json.forEach((element) {
      data.add(VendorProductsDataModel.fromJson(element));
    });
  }
}

class VendorProductsDataModel {
  String? id;
  String? prodId;
  String? userId;
  String? compId;
  ...
  VendorProductsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    khasem = json['khasem'];
