class AllOffersModel{
  List<AllOffersDataModel>data=[];
  AllOffersModel.fromJson(var json){
    json.forEach((element) {
      data.add(AllOffersDataModel.fromJson(element));
    });
  }
}

class AllOffersDataModel {
  ...
  AllOffersDataModel.fromJson(Map<String, dynamic> json){
    id = json['id'];
    prodId = json['prod_id'];
    userId = json['user_id'];
    compId = json['comp_id'];
