class CountryProductsModel{
  List<CountryProductsDataModel>data=[];
  CountryProductsModel.fromJson(var json){
    json.forEach((element) {
      data.add(CountryProductsDataModel.fromJson(element));
    });
  }
}

class CountryProductsDataModel {
  String? id;
  String? prodId;
  String? userId;
  String? compId;
  ...
  CountryProductsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    prodId = json['prod_id'];
    khasem = json['khasem'];
