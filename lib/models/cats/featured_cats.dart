class FeaturedCategoriesModel{
  List<FeaturedCategoriesDataModel>data=[];
  FeaturedCategoriesModel.fromJson(var json){
    json.forEach((element) {
      data.add(FeaturedCategoriesDataModel.fromJson(element));
    });
  }
}

class FeaturedCategoriesDataModel {
  String? id;
  String ?userId;
  String? compId;
  String? catId;
  ...
  FeaturedCategoriesDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    compId = json['comp_id'];
    catId = json['cat_id'];
