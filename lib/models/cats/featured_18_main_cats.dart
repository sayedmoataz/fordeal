class Featured10CatsModel{
  List<Featured10CatsDataModel>data=[];
  Featured10CatsModel.fromJson(var json){
    json.forEach((element) {
      data.add(Featured10CatsDataModel.fromJson(element));
    });
  }
}

class Featured10CatsDataModel {
  String? id;
  String? userId;
  String? compId;
  String? catId;
  ...
  Featured10CatsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    compId = json['comp_id'];
    catId = json['cat_id'];
