class SubCats4ProdsModel{
  List<SubCats4ProdsDataModel>data=[];
  SubCats4ProdsModel.fromJson(var json){
    json.forEach((element) {
      data.add(SubCats4ProdsDataModel.fromJson(element));
    });
  }
}
...
class SubCats4ProdsDataModel {
  ...
  SubCats4ProdsDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    compId = json['comp_id'];
    catId = json['cat_id'];
