  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeStates>(
        ...
        builder: (context, state) {
          ...
          return cubit.countryMainCategoryProductsModel2 == null
              ? Center(
                  ...
                  child: Column(
                    children: [
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Column(children: [
                                  ClipRRect(
                                    ...
                                    child: Container(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        imageUrl:'https://alhasnaa.site/files/${cubit.sub8catModel2!.data[index].catIcone!}',
                                        fit: BoxFit.cover,
                                        width: double.infinity,
                                      ),
                                    ),
                                  ...
                                  Text(cubit
                                      .sub8catModel2!.data[index].catNameAr!),
                                  Padding(
                      ...
                      MasonryGridView.builder(
                        ...
                        crossAxisSpacing:8,
                        itemCount: cubit
                            .countryMainCategoryProductsModel2!.data.length,
                        physics: NeverScrollableScrollPhysics(),
                        shrinkWrap: true,
                        ...
                        itemBuilder: (context, index) => InkWell(
                          onTap: () async {
                            cubit.getSingleProduct(cubit
                                ...
                                .prodId
                                .toString());
                            await cubit.checkProdInFavorite( cubit.countryMainCategoryProductsModel2!
                                .data[index]
                                .prodId
                                .toString());
                            Navigator.push(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Image.network(
                                      'https://alhasnaa.site/files/${cubit.countryMainCategoryProductsModel2!.data[index].prodImg!}',
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                  // Padding(
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(4),
                                    child: Text(
                                      cubit.countryMainCategoryProductsModel2!
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(4),
                                    child: Text((int.parse( cubit.countryMainCategoryProductsModel2!
